        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
          {models.map((model, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`relative mb-4 mx-auto w-fit p-4 bg-gradient-to-br ${model.gradient} rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110`}
              >
              ...
              <div className="space-y-2 mb-6">
                {model.features.slice(0, 2).map((feature, featureIndex) => (
                  ...
                  >
                    <div
                      className={`w-1.5 h-1.5 bg-gradient-to-r ${model.gradient} rounded-full`}
                    />
