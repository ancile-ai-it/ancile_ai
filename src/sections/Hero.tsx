...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-teal-800 text-white overflow-hidden mb-8">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 pb-8">
        {/* Tagline */}
        <div className="text-center mb-8">
          <p className="text-teal-200 font-medium text-lg tracking-wide mb-4">
            Strategic AI Implementation for Government Excellence
          </p>
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
            <Shield className="h-5 w-5 text-teal-300" />
            <span className="text-sm font-medium">Founded by Veterans for Mission-Critical Success</span>
          </div>
        </div>

        {/* Main Headlines */}
        <div className="text-center mb-20 relative">
          <h1 className="text-4xl md:text-6xl font-bold mb-12 leading-tight relative z-10">
            Transforming Government
            <span className="bg-gradient-to-r from-teal-300 to-orange-300 bg-clip-text text-transparent block pb-4 mb-2 px-4 relative z-30 inline-block">
              Through Expert AI
            </span>
          </h1>
